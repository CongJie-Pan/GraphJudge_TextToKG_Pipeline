...
- **Work Description**:
    ...
    - **How**: 
        1. Analyze `chat/run_entity.py` to identify core business logic
        2. Extract GPT-5-mini entity extraction functionality 
        3. Create simplified `extract_entities()` function with clean interface
        4. Implement in-memory result handling instead of file-based storage
        5. Add essential error handling without complex retry mechanisms
- **Resources Required**:
...
- **Deliverables**:
    ...
    - [ ] Unit tests in `test_entity_processor.py`
...
- **Work Description**:
    ...
    - **How**:
        1. Design clean data models using Python dataclasses
        2. Create unified configuration system for API keys and model parameters
        3. Implement validation utilities for input data
        4. Set up shared constants and enums
- **Resources Required**:
    ...
    - **Reference Codes**:
        ...
        - Spec.md Section 8 for data model definitions
- **Deliverables**:
...
- **Work Description**:
    ...
    - **How**:
        1. Set up pytest framework with asyncio support
        2. Create mock API response fixtures for GPT-5-mini and Perplexity
        3. Implement test utilities for common testing patterns
        4. Create integration test harnesses
- **Resources Required**:
...
- **Work Description**:
    ...
    - **How**:
        1. Analyze `chat/run_triple.py` to identify core triple generation logic
        2. Extract JSON schema validation with Pydantic models
        3. Implement simplified text chunking for large inputs
        4. Create clean `generate_triples()` interface
        5. Preserve prompt engineering sophistication
- **Resources Required**:
...
- **Work Description**:
    ...
    - **How**:
        1. Create clean API client interface using litellm
        2. Implement basic rate limiting and error handling
        3. Add support for different model types (GPT-5-mini, Perplexity)
        4. Provide consistent response formatting
- **Resources Required**:
...
- **Work Description**:
    ...
    - **How**:
        1. Analyze massive `run_gj.py` script to identify essential logic
        2. Focus on Perplexity API integration initially
        3. Extract core graph judgment algorithms
        4. Implement basic explainable reasoning mode
        5. Defer complex multi-API support for future iterations
- **Resources Required**:
...
- **Work Description**:
    ...
    - **How**:
        1. Design clean error handling strategy returning errors as data
        2. Implement Streamlit-compatible logging
        3. Create user-friendly error messages
        4. Add progress indication mechanisms
- **Resources Required**:
...
- **Work Description**:
    ...
    - **How**:
        1. Design clean Streamlit UI with text input and results display
        2. Implement three-stage pipeline orchestration
        3. Add progress indicators and real-time feedback
...
- **Resources Required**:
    ...
    - **Reference Codes**:
        ...
        - UI flow specifications from spec.md Section 5
- **Deliverables**:
...
- **Work Description**:
    ...
    - **How**:
        1. Design session state schema for pipeline data
        2. Implement data persistence across Streamlit reruns
        3. Add state management utilities
        4. Handle state cleanup and reset functionality
- **Resources Required**:
    - **Materials**: Streamlit session state documentation
    - **Personnel**: 1 Developer (estimated 2-3 days)
    - **Reference Codes**:
        - Streamlit session state examples
        - Data flow patterns from spec.md
- **Deliverables**:
